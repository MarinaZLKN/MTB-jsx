...
class Post(models.Model):
    ...
    photo1 = models.FileField(upload_to='news/photos/', blank=True)
    photo2 = models.FileField(upload_to='news/photos/', blank=True)
    photo3 = models.FileField(upload_to='news/photos/', blank=True)
    photo4 = models.FileField(upload_to='news/photos/', blank=True)
    photo5 = models.FileField(upload_to='news/photos/', blank=True)
    photo6 = models.FileField(upload_to='news/photos/', blank=True)
    photo7 = models.FileField(upload_to='news/photos/', blank=True)
    photo8 = models.FileField(upload_to='news/photos/', blank=True)
    photo9 = models.FileField(upload_to='news/photos/', blank=True)
    photo10 = models.FileField(upload_to='news/photos/', blank=True)
...
class Merchandise(models.Model):
    ...
    photo1 = models.FileField(upload_to='merchandise/', blank=True)
    photo2 = models.FileField(upload_to='merchandise/', blank=True)
    photo3 = models.FileField(upload_to='merchandise/', blank=True)
